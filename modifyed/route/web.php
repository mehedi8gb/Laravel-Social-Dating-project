...
// Complaints
Route::view('complaints','index.complaints');
Route::post('complaints','HomeController@complaints');
...
event(new MessageNotifyEvent('message body demo'));
return 'its done';
  });
...
return view('index.test');
 ...
 Route::group(['middleware' => 'auth'], function() {
     ...
     // mehedi
	 Route::get('ajax/messages', 'UserController@ajaxMessages')->name('message.ajax');
	...
	// Notifications
 	...
 	Route::get('settings/notifications','UserController@notificationSettingPage')->name('notification-setting');
...
Route::view('panel/admin/announcements','admin.announcements')->middleware('role');
