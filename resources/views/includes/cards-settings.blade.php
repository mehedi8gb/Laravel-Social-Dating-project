	...
	<div class="card shadow-sm card-settings">
			<div class="list-group list-group-sm list-group-flush">
				...
				@endif
                    ...
                    {{-- mehedi --}}
					<a href="{{url('settings/notifications')}}" class="list-group-item list-group-item-action d-flex justify-content-between @if(request()->is('settings/notifications')) active @endif">
							<div>
                                    <i class="far fa-bell mr-2"></i>
									<span>{{trans('general.notifications')}}</span>
							</div>
							<div>
									<i class="feather icon-chevron-right"></i>
							</div>
