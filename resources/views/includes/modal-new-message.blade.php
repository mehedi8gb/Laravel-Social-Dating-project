						...
						<div class="mb-2">
							...
							@if (auth()->user()->verified_id == 'yes' && request()->is('messages') && auth()->user()->totalSubscriptionsActive() > 1)
								<span class="form-text">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#newMessageMassive" data-dismiss="modal" class="small">
				...
				<div class="card-footer bg-white border-0 pt-0 position-relative">
					...
					<div class="justify-content-between align-items-center">
						...
						<div class="d-inline-block float-right mt-3">
							<button disabled type="submit" id="button-reply-msg" class="btn btn-sm btn-primary rounded-pill float-right"><i class="far fa-paper-plane"></i></button>
						</div>
