<div class="card border-0 bg-transparent">
  <div class="card-body p-0">
    ...
    <ul class="list-inline mb-0 small">   
      @foreach (Pages::take(7)->get() as $page)
	  ...
	  <li class="list-inline-item"><a class="link-footer footer-tiny" target="_blank" href="https://secure.livechatinc.com/licence/1041032/open_chat.cgi?groups=41">{{ trans('general.livechat') }}</a></li>
	  <li class="list-inline-item"><a class="link-footer footer-tiny" target="_blank" href="https://support.ccbill.com">{{ trans('general.billing') }}</a></li>
	  <li class="list-inline-item"><a class="link-footer footer-tiny" href="{{ url('/complaints') }}" >Consumer Complaints</a></li>
