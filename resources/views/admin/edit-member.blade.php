       ...
       <div class="row">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text"  disabled value="{{ $data->email }}" class="form-control" placeholder="{{ trans('auth.email') }}">
              </div>
            </div>
          </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" autocomplete="off" value="{{ $data->wallet }}" name="wallet" class="form-control isNumber" placeholder="{{ trans('general.wallet') }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
