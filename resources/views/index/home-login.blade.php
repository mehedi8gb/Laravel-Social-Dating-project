...
@section('content')
  <div class="jumbotron m-0" style="height: 93vh; width:100%; background-size: cover;  background-repeat:no-repeat;background-image:url(public/img/background-image.webp)">
      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          <div class="text-center d-block w-100">
            <img src="public/img/logo-1636104555.webp" alt="{{$settings->title}}" width="50%" class="logo align-baseline mb-1" />
          </div>
&nbsp;
