...
@section('title') {{trans('general.complaints')}} -@endsection
        ...
        <div class="col-lg-8">
          ...
          <div class="p-4">
            <h4 class="text-center mb-0 font-weight-bold">
              {{trans('general.complaints')}}
            </h4>
            <small class="btn-block text-center mt-2">{{ trans('general.subtitle_complaints') }}</small>
          </div>
