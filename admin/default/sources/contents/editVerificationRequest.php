                ...
                <div class="i_post_u_images"> 
                    ...
                    echo '<div class="i_image_two" id="lightgallery'.$verificationRequestedUserID.'">'; 
                            ...
                            if($fileData){
                                ...
                                $fileisIDOne = 'data-src="'.$filePathUrl.'"'; 
                            }
                            ...
                            if($fileDataTwo){
                                ...
                                $fileIDTwo = 'data-src="'.$filePathUrlTwo.'"'; 
                            }
                        ?>
                        <div class="i_post_image_swip_wrapper" style="background-image:url('<?php echo filter_var($filePathUrl, FILTER_SANITIZE_STRING);?>');" <?php echo html_entity_decode($fileisIDOne);?>> 
                                <img class="i_p_image" src="<?php echo filter_var($filePathUrl, FILTER_SANITIZE_STRING);?>">
                            </div> 
                        <div class="i_post_image_swip_wrapper" style="background-image:url('<?php echo filter_var($filePathUrlTwo, FILTER_SANITIZE_STRING);?>');" <?php echo html_entity_decode($fileIDTwo);?>> 
