<div class="i_admin_left">
  ...
  <div class="i_admin_menu_wrapper flex_ column">
      ...
      <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>contact_mails">
        <div class="menu_item flex_ tabing_non_justify transition border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'contact_mails' ? "active_p" : ""; ?>">
            <div class="flex_ tabing menu_svg"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('96'));?></div><div class="flex_ lm"><?php echo filter_var($LANG['questions_from_users'], FILTER_SANITIZE_STRING);?></div>
        </div>
      </a>
      ...
      <div class="menu_item subCaller flex_ tabing_non_justify transition border_one <?php echo in_array($pageFor, ['reported_posts', 'reported_comments']) ? "active_p" : ""; ?>" data-id="reported_posts">
          <div class="flex_ tabing menu_svg"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('32'));?></div><div class="flex_ lm"><?php echo filter_var($LANG['reports'], FILTER_SANITIZE_STRING);?></div>
          <div class="sub_menu_arrow"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('36'));?></div>
      </div> 
      <div class="sub_menu_wrapper border_one flex_ column <?php echo in_array($pageFor, ['reported_posts', 'reported_comments']) ? 'sub_in' : '' ?>" id="reported_posts">
            ...
            <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>reported_posts">
              <div class="sub_menu_item transition flex_ tabing_non_justify border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'reported_posts' ? "active_p" : ""; ?>">
                <div class="flex_ lm"><?php echo filter_var($LANG['reported_posts'], FILTER_SANITIZE_STRING);?> (<?php echo $iN->iN_GetTotalReportedPost($userID);?>)</div>
              </div>
            </a>  
            <a href="<?php echo filter_var($base_url, FILTER_SANITIZE_STRING).'admin/';?>reported_comments">
              <div class="sub_menu_item transition flex_ tabing_non_justify border_one <?php echo filter_var($pageFor, FILTER_SANITIZE_STRING) == 'reported_comments' ? "active_p" : ""; ?>">
                <div class="flex_ lm"><?php echo filter_var($LANG['reported_comments'], FILTER_SANITIZE_STRING);?> (<?php echo $iN->iN_GetTotalReportedComment($userID);?>)</div>
              </div>
            </a>
