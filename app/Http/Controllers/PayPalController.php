  ...
  switch ($txn_type) {
    ...
    case 'subscr_payment':
      ...
      // Check outh POST variable and insert in DB
        ...
        $this->transaction($txn_id, $data['subscriber'], $subscription->id, $data['id'], $data['amount'], $earnings['user'], $earnings['admin'], 'PayPal', 'subscription', $earnings['percentageApplied']);
