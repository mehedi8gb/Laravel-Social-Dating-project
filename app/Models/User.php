...
class User extends Authenticatable implements HasLocalePreference
{
    ...
    {
      return $this->belongsToMany('App\Models\Updates', 'media','user_id','updates_id')->where('media.status', 'active');
    }
  	...
  	public function country()
    {
      ...
      {
            return $this->hasMany(Messages::class, 'to_user_id')->where('to_user_id', Auth::user()->id)->where('status','new')->latest()->first();
      }
